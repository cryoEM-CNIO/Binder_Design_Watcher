...
# Choosing GPU in the node
parser.add_argument( "-gpu_id", type=str, default='0', help='Index of the GPU where you want to run the job')
...
class ProteinMPNN_runner():
    ...
    def __init__(self, args, struct_manager):
        ...
        if torch.cuda.is_available():
            print('Found GPU will run ProteinMPNN on GPU'+str(args.gpu_id))
